...
const TestimonialsCard = ({ data }) => {
  return (
    <div className="w-full md:w-96 h-80 md:h-96 bg-primary flex flex-col gap-6 border-2 px-6 py-7 rounded-xl border-whyusborder cursor-pointer hover:bg-gray">
